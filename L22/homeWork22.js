 ...
 */
// Method creation task
console.log("counterFactory Task");
const counterFactoryMaker = function () {
    let count = 0;
    return {
            increment (){
                    count++;   
...
counterFactory = counterFactoryMaker();
...
console.log(myPow(2, -2, myPrint)) // 2^-2=0.25
console.log(myPow(-3, 4, myPrint)) // 3^4=81
console.log(myPow(0, 0, myPrint)) // 0^0=1

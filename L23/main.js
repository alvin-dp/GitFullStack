...
console.log("CalorieCalculator Task");
class CalorieCalculator {
  ...
  addProduct(prodName, prodCal) {
    this.productCalories.set(prodName, prodCal);
  }

  getProductCalories(productName) {
    const calories = this.productCalories.get(productName);    
    return (calories === undefined) ? "Product not found" : calories ;
  }

  removeProduct(productName) {
    this.productCalories.delete(productName);
  }
}

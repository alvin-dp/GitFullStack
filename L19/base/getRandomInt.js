...
console.log("function #1 getRandomInt");
console.log(getRandomInt(1, 1)); // error
console.log(getRandomInt(10, 1));// error
console.log(getRandomInt(1, 10)); // виводить випадкове число від 1 до 10
console.log(getRandomInt(1.3, 2.5)); // error
console.log(getRandomInt(1.3, 5)); // error
console.log(getRandomInt(1, 2.5)); // error
console.log(getRandomInt(40, 50)); // виводить випадкове число від 40 до 50
console.log(getRandomInt(1, 100)); // виводить випадкове число від 1 до 100
console.log(getRandomInt(-50, 50)); // виводить випадкове число від -50 до 50
